        ...
        <div className="flex justify-between h-32">
          <div className="flex items-center">
            ...
            <div className="hidden md:flex flex-grow justify-end ml-[830px] items-right">
              <div className="ml-10 flex items-baseline ">
                <Link
                  to="/about"
                  className={`text-white hover:bg-gray-700 hover:text-white px-3 py-4 rounded-md text-sm font-medium`}
                >
                  About Us
                </Link>
                <Link
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              ...
              type="button"
              className={`text-white inline-flex items-center justify-center p-2 text-gray-400 `}
      ...
      {isOpen && (
        <div className="md:hidden text-center" id="mobile-menu">
          <div className="px-2 pt-2 pb-16 space-y-1 sm:px-3">
            <Link
              to="/about"
              className={`text-white text-6xl block px-3 py-2 rounded-md text-base font-medium`}
            >
              About
            </Link>
            <Link
